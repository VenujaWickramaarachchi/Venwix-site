...
const WhatsAppButton = () => (
  <motion.a
    ...
    className='fixed bottom-4 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg shadow-[#25D366]/30 flex items-center justify-center hover:bg-[#20bd5a] transition-colors'
